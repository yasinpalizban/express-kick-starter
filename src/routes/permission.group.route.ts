...
import { PermissionGroupValidation } from '../validations/permission.group.validation';
...
export default class PermissionGroupRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}`, authMiddleware, validationMiddleware(PermissionGroupValidation, 'body'), this.controller.create);
    this.router.put(`${this.path}/:id`, authMiddleware, validationMiddleware(PermissionGroupValidation, 'body', true), this.controller.update);
